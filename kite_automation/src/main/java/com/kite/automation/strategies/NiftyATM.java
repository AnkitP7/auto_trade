...
//@Slf4j
//@NoArgsConstructor
//public class NiftyATM extends AbstractStrategy{
//
...
//
//        callSymbol = strategyConfig.getSymbol()+atmStrikePrice+"CE";
//        putSymbol = strategyConfig.getSymbol()+atmStrikePrice+"PE";
//
